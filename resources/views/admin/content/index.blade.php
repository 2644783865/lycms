            ...
            <div class="nav-tabs-custom">
                ...
                <form class="form-inline" name="list-form" id="list-form" action="" method="get">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" name="keyword" placeholder="搜索关键词">
                    </div>
                    <div class="form-group">
                        <input name="time1" type="text" autocomplete="off" placeholder="开始时间"
                               class="form-control js-datepicker"
                               value="{{$_GET['time1']??''}}"
                               data-date-format="yyyy/mm/dd"/> 至
                        <input name="time2" type="text" autocomplete="off" placeholder="结束时间"
                               class="form-control js-datepicker"
                               value="{{$_GET['time2']??''}}"
